...
public class DBScheduler {
    ...
    private void callScheduler() throws Exception {
        System.out.println("Scheduler Started for testing server connection...");
        ReadPropertiesFile.readConfig();
        Timer timer = new Timer();
        timer.scheduleAtFixedRate(new TestServerConnection(), getTimePrecision(Constants.delay), getTimePrecision(Constants.timetoquery));
    }

    private long getTimePrecision(String value) throws Exception {
        long l = 0;
        String val;
        try {
