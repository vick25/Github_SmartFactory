...
public final class JRViewer extends javax.swing.JPanel implements JRHyperlinkListener {
    ...
    private final MouseListener mouseListener = new java.awt.event.MouseAdapter() {
    ...
    protected KeyListener keyNavigationListener = new KeyAdapter() {
    ...
    protected void initSaveContributors() {
        ...
        for (String DEFAULT_CONTRIBUTORS1 : DEFAULT_CONTRIBUTORS) {
            try {
                Class saveContribClass = JRClassLoader.loadClassForName(DEFAULT_CONTRIBUTORS1);
	...
	void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            ...
            for (Object saveContributor : saveContributors) {
                fileChooser.addChoosableFileFilter((JRSaveContributor) saveContributor);
            }
    ...
    protected void hyperlinkClicked(JRPrintHyperlink hyperlink) {
        try {
            JRHyperlinkListener listener;
            for (Object hyperlinkListener : hyperlinkListeners) {
                listener = (JRHyperlinkListener) hyperlinkListener;
            ...
            if (index >= 0 && index < jasperPrint.getPages().size()) {
                ...
                lblStatus.setText(
                        MessageFormat.format(
                                ...
                                new Object[]{pageIndex + 1, jasperPrint.getPages().size()}));
            }
        } else {
