...
public class MachineTargetParameters extends javax.swing.JPanel {
...
//    }
    public MachineTargetParameters(String machine) throws SQLException, ParseException {
        _machine = machine;
        initComponents();
...
//        getDsStartTime().setValue(new SimpleDateFormat("HH:mm").parse("20:30"));
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Break Options", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 204)));
        ...
        comboBox.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getItem().toString().equals("Add ...") && comboBox.getSelectedIndex() == comboBox.getItemCount() - 1) {
                    ...
                    try {
                        AddBreakName abn = new AddBreakName(null, true, MachineTargetParameters.this);
                        abn.setVisible(true);
...
//                            }
    ...
    private final ImageIcon removeIcon = IconsFactory.getImageIcon(MachineTargetParameters.class, "/images/icons/office/remove_package.png");
    private final ImageIcon removeRolloverIcon = IconsFactory.getImageIcon(MachineTargetParameters.class, "/images/icons/office/remove_package_rollover.png");
}
