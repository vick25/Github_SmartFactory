 ...
 */
public class ProductionQuickView1 extends javax.swing.JPanel {
    ...
    public static void setTotProdSelected(boolean totProdSelected) {
        ProductionQuickView1.totProdSelected = totProdSelected;
    }

    public ProductionQuickView1(JFrame parent) throws SQLException {
        this._parent = parent;
//        ball = new Ball(this);
        initComponents();
                    ...
                    if (selected.length <= 0) {
                        ...
                        try {
                            if (!btnProductionRate.isEnabled()) {
                                _sortableTable = ProductionQuickView1.tableRate;
                            } else if (!btnTotalProduction.isEnabled()) {
                                _sortableTable = ProductionQuickView1.tableTotal;
                            }
...
//        });
    ...
    private void refreshMachine_Targets() throws SQLException {
        ...
        try {
            ...
            Logger.getLogger(ProductionQuickView1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
    ...
    synchronized private void runMachineSelection(final ArrayList<String> listMachines, String configurationType)
        ...
        nbRow = 1;
        if (!btnProductionRate.isEnabled()) {
            cleanTable(ProductionQuickView1.tableRate);
        } else if (!btnTotalProduction.isEnabled()) {
            cleanTable(ProductionQuickView1.tableTotal);
        }
        try {
            ...
            for (String machine : listMachines) {
                ...
                stringTokenizer = new StringTokenizer(machine, ";");
...
//            terminate = true;
    ...
    synchronized private void runQueryFillTable(String query, SortableTable table, String machineName,
            int configNo, int pan) throws SQLException {
        logTimeList.clear();
        logDataList.clear();
...
//            cblMachine.getCheckBoxListSelectionModel().addSelectionInterval(0, cblMachine.getModel().getSize() - 1);
    ...
    public static void main(String[] agrs) throws SQLException {
        ...
        frame.setContentPane(new ProductionQuickView1(null));
...
//    private volatile boolean terminate = false;
    ...
    private ArrayList<String> log_TimeData_List, logTimeList = new ArrayList<>();
    private ArrayList<Integer> logDataList = new ArrayList<>();
