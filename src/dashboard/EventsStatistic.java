...
import eventsPanel.EventsDataPanel;
import eventsPanel.EventsHierarchicalTable;
import eventsPanel.StatKeyFactory;
import eventsPanel.StatSetting;
...
public class EventsStatistic extends javax.swing.JPanel {
    ...
    public EventsStatistic(JFrame parent) {
        initComponents();
        new ConnectDB();
        this.parent = parent;
        ...
        setPropertiesSaved(pref.get("prod", getPropertiesToSave()));
    }
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblFrom, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblTo, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE))
        );
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(spProductionRate, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Events of", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12), new java.awt.Color(0, 102, 255))); // NOI18N

        btnDataEvent.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(btnDataEvent);
        btnDataEvent.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        btnTimeEvent.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(radMinute, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(radSecond, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jToolBar7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Events Statistics", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(0, 102, 255))); // NOI18N
        ...
        jToolBar9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Options", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(0, 102, 255))); // NOI18N
        ...
        lblTimeSum.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N

        javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
        jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblTimeSum, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(_field, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
    ...
    private void btnPrintChartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintChartActionPerformed
        reportOptions = new ReportOptions(parent, true);
        ...
        Thread threadPrint = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    chart.setTitle("");
                    repTemp = new File(tampon + File.separator + "SmartFactory Data");
                    if (!repTemp.exists()) {
                        repTemp.mkdirs();
                    }
                    ...
                    JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream(""
                            + "/jasper/chart.jasper"), hm, ConnectDB.con);
                    Print.viewReport(parent, jp, false, ConnectDB.LOCALE);
    ...
    private void cmbMachineTitleItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbMachineTitleItemStateChanged
        ...
        if (catMachine) {
            ...
            if (!cmbMachineTitle.getSelectedItem().equals("") && cmbMachineTitle.getSelectedIndex() > 0) {
                ...
                if (find) {
                    try {
                        createTreeDisplay();//create the tree with description as node and value as leaf
                        initFieldTree();
                    ...
                    lblFrom.setText("");
                    lblTo.setText("");
                    _field.setTreeModel(new DefaultTreeModel(new DefaultMutableTreeNode(emptyData)));
    ...
    private void getComponentDates() {
    ...
    /**
     * createTreeDisplay method gets the Description and Value from the EventLog
     * table and CustomList table given a start and end date specified. It then
     * create the tree with the Machine as the root node.
     */
    private void createTreeDisplay() {
        ...
        try {
            ...
            if (btnDataEvent.isSelected()) {
                ...
                ConnectDB.res = ps.executeQuery();
                while (ConnectDB.res.next()) {
                    time = ConnectDB.res.getString(2);//the period of a production rate value
                }
                ps.close();
            }
            ...
            if (time != null) {
                ...
                //From the space of time given, get the events (Description and Value) from eventlog table
                ...
                ps.close();
//                //Dummy data for examples and show
//                setDescription.add(maintenance);
//                setDescription.add(operator);
//                for (int i = 0; i < array.length; i++) {
//                    while (i > 5) {
//                        setDescriptionValue.add(maintenance + "," + array[i].toLowerCase());
//                        break;
//                    }
//                    setDescriptionValue.add(operator + "," + array[i].toLowerCase());
//                }
//                //
                if (loopQueryFound) {//boolean value for description and value
                    ...
                    for (String sDesc : setDescription) {
                        ...
                        for (Enumeration enumData = data.elements(); enumData.hasMoreElements();) {
                            ...
                            if (machData.getMachDomain().equals(sDesc)) {//check for description
                    ...
                    _field.setTreeModel(new DefaultTreeModel(new DefaultMutableTreeNode(emptyData)));
                    JOptionPane.showMessageDialog(parent, "No data found and retrieved. Please check "
                            + "the periods provided", "Events", JOptionPane.WARNING_MESSAGE);
                    jScrollPane2.setViewportView(null);
                    lblTimeSum.setText("");
                }
            } else {
    ...
    /**
     * This method sort the value by its corresponding description under a
     * selected machine. It uses the Machine class
     */
            ...
            _tree.addTreeSelectionListener(new TreeSelectionListener() {
                ...
                public void valueChanged(TreeSelectionEvent e) {
                    ...
                    runThread = new Thread(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            drawChart();//draw the chart when clicking on a tree node (leaf or main node)
                        }
                    });
                    runThread.start();
                }
    ...
    /**
     * drawChat method called from the initFieldTree method when a node is
     * selected
     */
    private void drawChart() {
        try {
            ...
            if (path != null) {
                String valTitle = chartTitle();//method to get the title for the chart by clicking on the tree
...
//            System.out.println(query);
        if (!query.isEmpty()) {
            if (btnDataEvent.isSelected()) {//Events of data
                ...
                //Create the charts
                lblTimeSum.setText("Max " + timeFormat + ": " + max);
    ...
    private static String chartTitle() {
        ...
        if (path != null) {
            if (!_tree.getModel().isLeaf(path.getLastPathComponent())) {
                title = path.getPath()[0].toString();//Root title
                if (!_tree.getModel().isLeaf(path.getLastPathComponent())
                    ...
                    title = title.substring(0, title.length() - 1).toLowerCase();//Node title
                }
            } else {//case is a leaf
//                System.out.println("leaf");
    ...
    private static Axis chartTitleAxis() {
        ...
        switch (timeFormat) {
            ...
            case "min":
                ...
                break;
            case "fictuous value":
                yAxis = chartTitleAxis(300, "Fic", "Fictitious value");
                break;
            default:
    ...
    public static void createPieChart() {
        ...
        JToggleButton btnPercentage = new JToggleButton("(%) Percentage");
        btnPercentage.setFocusable(false);
        btnPercentage.setToolTipText("Percentage of " + ConnectDB.DECIMALFORMAT.format(totalSum) + " total sum");
...
//                System.out.println("button is selected");
    ...
    private void enableResetButton() {
        if (cmbMachineTitle.getSelectedIndex() > 0 || cmbValue.getSelectedObjects().length != 0
                || cmbDescription.getSelectedObjects().length != 0 || panChart.getComponentCount() > 0) {
    ...
    private static String getPropertiesToSave() {
        ...
        if (cmbEFrom.getDate() != null) {
            properties += cmbEFrom.getDate().getTime() + "\r\n";
        } else {
            properties += null + "\r\n";
        }
        if (cmbETo.getDate() != null) {
            properties += cmbETo.getDate().getTime() + "\r\n";
        } else {
            properties += null + "\r\n";
        }
        return properties;
...
//                    frame.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    private boolean loopQueryFound = false, addValue = false, saved = true, skipFirstMessage = true;//variables for the dates;  
    static boolean catMachine, catDescription;//check if all the machineTitle title are loaded
    static int max = 0;
    ...
    static CategoryRange<ChartCategory> colors = new CategoryRange<>();
    ...
    public static String machineTitle, propertiesToSave = "", customCodeValue = "";
    public static Set<String> setDescription = new TreeSet<>(), setDescOrValue = new TreeSet<>();
    private final Preferences pref = Preferences.userNodeForPackage(EventsStatistic.class);
    public Timer timer;
    public EventsHierarchicalTable eht;
    File repTemp;
    JFrame parent;
    Thread runThread;
    ReportOptions reportOptions;
    String dirIcon = "", maintenance = "Maintenance".toLowerCase(), operator = "Operator".toLowerCase(),
            tampon = new File(new JFileChooser().getCurrentDirectory().getAbsolutePath()).getParent(),
            emptyData = "***NO EVENT RETREIVED***";
    String[] array = new String[]{"no material", "lubrication", "no power", "meeting", "fixing comgape",
        "recut jaws", "press set-up", "flakes set up", "foot pedal broken", "Polish Mandril"};
    ViewData viewData = new ViewData(parent, false, null);
