...
public class JasperDesignViewer extends javax.swing.JFrame {
     ...
     * 
     */
    public JasperDesignViewer(JasperReportsContext jasperReportsContext, String sourceFile, boolean isXML)
            throws JRException {
        initComponents();
     ...
     * 
     */
    public JasperDesignViewer(JasperReportsContext jasperReportsContext, InputStream is, boolean isXML)
            throws JRException {
        initComponents();
     ...
     *
     */
    public static void viewReportDesign(JasperReportsContext jasperReportsContext, String sourceFile, boolean isXML)
            throws JRException {
     ...
     *
     */
    public static void viewReportDesign(JasperReportsContext jasperReportsContext, InputStream is, boolean isXML)
            throws JRException {
