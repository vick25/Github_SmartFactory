...
public class JasperViewer extends javax.swing.JFrame {
    ...
    public JasperViewer(String sourceFile, boolean isXMLFile, boolean isExitOnClose, Locale locale) throws JRException {
        this(DefaultJasperReportsContext.getInstance(), sourceFile, isXMLFile, isExitOnClose, locale, null);
    }
    ...
    public JasperViewer(InputStream is, boolean isXMLFile, boolean isExitOnClose, Locale locale) throws JRException {
        this(DefaultJasperReportsContext.getInstance(), is, isXMLFile, isExitOnClose, locale, null);
    }
     ...
     * 
     */
    public JasperViewer(JasperReportsContext jasperReportsContext, String sourceFile, boolean isXMLFile,
            boolean isExitOnClose, Locale locale, ResourceBundle resBundle) throws JRException {
        if (locale != null) {
            setLocale(locale);
        }
     ...
     * 
     */
    public JasperViewer(JasperReportsContext jasperReportsContext, InputStream is, boolean isXMLFile,
            boolean isExitOnClose, Locale locale, ResourceBundle resBundle
    ) throws JRException {
        if (locale != null) {
            setLocale(locale);
        }
    ...
    public JasperViewer(JasperReportsContext jasperReportsContext, JasperPrint jasperPrint, boolean isExitOnClose,
            Locale locale, ResourceBundle resBundle) {
        if (locale != null) {
            setLocale(locale);
        }
        this.isExitOnClose = isExitOnClose;
    ...
    public static void viewReport(String sourceFile, boolean isXMLFile, boolean isExitOnClose, Locale locale) throws JRException {
        viewReport(DefaultJasperReportsContext.getInstance(), sourceFile, isXMLFile, isExitOnClose, locale,
                null);
    }
    ...
    public static void viewReport(InputStream is, boolean isXMLFile, boolean isExitOnClose, Locale locale) throws JRException {
        viewReport(DefaultJasperReportsContext.getInstance(), is, isXMLFile, isExitOnClose, locale, null);
    }
    ...
    public static void viewReport(JasperPrint jasperPrint, boolean isExitOnClose, Locale locale) {
        viewReport(DefaultJasperReportsContext.getInstance(), jasperPrint, isExitOnClose, locale, null);
    }

    /**
     *
     */
    public static void viewReport(JasperReportsContext jasperReportsContext, String sourceFile, boolean isXMLFile,
            boolean isExitOnClose, Locale locale, ResourceBundle resBundle) throws JRException {
        JasperViewer jasperViewer = new JasperViewer(jasperReportsContext, sourceFile, isXMLFile, isExitOnClose,
                locale, resBundle);
     ...
     *
     */
    public static void viewReport(JasperReportsContext jasperReportsContext, InputStream is, boolean isXMLFile,
            boolean isExitOnClose, Locale locale, ResourceBundle resBundle) throws JRException {
        JasperViewer jasperViewer = new JasperViewer(jasperReportsContext, is, isXMLFile, isExitOnClose,
                locale, resBundle);
        jasperViewer.setVisible(true);
    }
    ...
    public static void viewReport(JasperReportsContext jasperReportsContext, String sourceFile, boolean isXMLFile,
            boolean isExitOnClose) throws JRException {
        viewReport(jasperReportsContext, sourceFile, isXMLFile, isExitOnClose, null, null);
    }
    ...
    public static void viewReport(JasperReportsContext jasperReportsContext, InputStream is, boolean isXMLFile,
            boolean isExitOnClose) throws JRException {
        viewReport(jasperReportsContext, is, isXMLFile, isExitOnClose, null, null);
    }
     ...
     */
    public static void viewReport(JasperReportsContext jasperReportsContext, JasperPrint jasperPrint, boolean isExitOnClose) {
        viewReport(jasperReportsContext, jasperPrint, isExitOnClose, null, null);
    }
